...
#### Parameters
- <p><code class="key">input</code> <code class="type">ClientInput</code></p>
Configure the client.
</Section>
<InlineSection>
**Returns** <code class="type">Client</code>
</InlineSection>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">(refresh: <code class="primitive">string</code>, opts?: <code class="type">RefreshOptions</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="type">RefreshSuccess</code><code class="symbol"> | </code><code class="type">RefreshError</code><code class="symbol">&gt;</code></code>
</InlineSection>
</Section>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">(subjects: <code class="type">T</code>, token: <code class="primitive">string</code>, options?: <code class="type">VerifyOptions</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="type">VerifyError</code><code class="symbol"> | </code><code class="type">VerifyResult</code><code class="symbol">&gt;</code></code>
</InlineSection>
</Section>
...
<Segment>
<Section type="parameters">
- <p>[<code class="key">challenge</code>](#authorizeresult.challenge) <code class="type">Challenge</code></p>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="type">Challenge</code>
</InlineSection>
</Section>
...
<Segment>
<Section type="parameters">
- <p>[<code class="key">err</code>](#exchangeerror.err) <code class="type">InvalidAuthorizationCodeError</code></p>
</Section>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="type">InvalidAuthorizationCodeError</code>
</InlineSection>
</Section>
...
- <p>[<code class="key">tokens</code>](#exchangesuccess.tokens) <code class="type">Tokens</code></p>
</Section>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="type">Tokens</code>
</InlineSection>
</Section>
...
<Segment>
<Section type="parameters">
- <p>[<code class="key">err</code>](#refresherror.err) <code class="type">InvalidRefreshTokenError</code><code class="symbol"> | </code><code class="type">InvalidAccessTokenError</code></p>
</Section>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="type">InvalidRefreshTokenError</code><code class="symbol"> | </code><code class="type">InvalidAccessTokenError</code>
</InlineSection>
</Section>
The type of error that occurred. You can handle this by checking the type.
```ts
...
- <p>[<code class="key">tokens?</code>](#refreshsuccess.tokens) <code class="type">Tokens</code></p>
</Section>
...
<Segment>
<Section type="parameters">
- <p>[<code class="key">err</code>](#verifyerror.err) <code class="type">InvalidRefreshTokenError</code><code class="symbol"> | </code><code class="type">InvalidAccessTokenError</code></p>
</Section>
...
- <p>[<code class="key">tokens?</code>](#verifyresult.tokens) <code class="type">Tokens</code></p>
</Section>
</Segment>
