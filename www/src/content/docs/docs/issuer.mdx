...
#### Parameters
- <p><code class="key">input</code> <code class="type">IssuerInput</code></p>
</Section>
<InlineSection>
...
<Segment>
<Section type="parameters">
- <p>[<code class="key">audience?</code>](#allowcallbackinput.audience) <code class="primitive">string</code></p>
- <p>[<code class="key">clientID</code>](#allowcallbackinput.clientid) <code class="primitive">string</code></p>
- <p>[<code class="key">redirectURI</code>](#allowcallbackinput.redirecturi) <code class="primitive">string</code></p>
</Section>
</Segment>
<NestedTitle id="allowcallbackinput.audience" Tag="h4" parent="AllowCallbackInput.">audience?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
...
<NestedTitle id="allowcallbackinput.clientid" Tag="h4" parent="AllowCallbackInput.">clientID</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">string</code>
...
<NestedTitle id="allowcallbackinput.redirecturi" Tag="h4" parent="AllowCallbackInput.">redirectURI</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">string</code>
...
<Segment>
<Section type="parameters">
- <p>[<code class="key">basePath?</code>](#issuerinput.basepath) <code class="primitive">string</code><code class="symbol"> | </code><code class="primitive">(req: <code class="type">Request</code>) => <code class="primitive">string</code></code></p>
- <p>[<code class="key">context?</code>](#issuerinput.context) <code class="primitive">(req: <code class="type">Request</code>) => <code class="type">RequestContext</code></code></p>
- <p>[<code class="key">cookies?</code>](#issuerinput.cookies) <code class="primitive">Object</code></p>
  - <p>[<code class="key">path?</code>](#cookies.path) <code class="primitive">string</code></p>
- <p>[<code class="key">providers</code>](#issuerinput.providers) <code class="type">Providers</code><code class="symbol"> | </code><code class="primitive">(ctx: <code class="type">Context</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="type">Providers</code><code class="symbol">&gt;</code></code></p>
- <p>[<code class="key">storage?</code>](#issuerinput.storage) <code class="type">StorageAdapter</code></p>
- <p>[<code class="key">subjects</code>](#issuerinput.subjects) <code class="type">Subjects</code></p>
- <p>[<code class="key">theme?</code>](#issuerinput.theme) <code class="type">Theme</code></p>
...
- <p>[<code class="key">allow?</code>](#issuerinput.allow) <code class="primitive">(input: <code class="type">AllowCallbackInput</code>, req: <code class="type">Request</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="primitive">boolean</code><code class="symbol">&gt;</code></code></p>
- <p>[<code class="key">refresh?</code>](#issuerinput.refresh) <code class="primitive">(response: <code class="type">OnSuccessResponder</code>, input: <code class="symbol">&lcub; </code><code class="key">clientID</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol">, </code><code class="key">properties</code><code class="symbol">&colon; </code><code class="primitive">any</code><code class="symbol">, </code><code class="key">subject</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol">, </code><code class="key">type</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol"> &rcub;</code>, req: <code class="type">Request</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="type">Response</code><code class="symbol">&gt;</code></code></p>
...
- <p>[<code class="key">success</code>](#issuerinput.success) <code class="primitive">(response: <code class="type">OnSuccessResponder</code>, input: <code class="type">Result</code>, req: <code class="type">Request</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="type">Response</code><code class="symbol">&gt;</code></code></p>
</Section>
</Segment>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">string</code><code class="symbol"> | </code><code class="primitive">(req: <code class="type">Request</code>) => <code class="primitive">string</code></code>
</InlineSection>
</Section>
...
<NestedTitle id="issuerinput.context" Tag="h4" parent="IssuerInput.">context?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">(req: <code class="type">Request</code>) => <code class="type">RequestContext</code></code>
</InlineSection>
</Section>
...
<NestedTitle id="issuerinput.cookies" Tag="h4" parent="IssuerInput.">cookies?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
...
<NestedTitle id="cookies.path" Tag="h5" parent="IssuerInput.cookies.">path?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">string</code>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="type">Providers</code><code class="symbol"> | </code><code class="primitive">(ctx: <code class="type">Context</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="type">Providers</code><code class="symbol">&gt;</code></code>
</InlineSection>
</Section>
...
When using tenant routes (
`/tenant/:tenantId/authorize`
), the tenant ID is available via
...
<Section type="parameters">
<InlineSection>
**Type** <code class="type">Subjects</code>
</InlineSection>
</Section>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="type">Theme</code>
</InlineSection>
</Section>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">(input: <code class="type">AllowCallbackInput</code>, req: <code class="type">Request</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="primitive">boolean</code><code class="symbol">&gt;</code></code>
</InlineSection>
</Section>
...
<NestedTitle id="issuerinput.refresh" Tag="h4" parent="IssuerInput.">refresh?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">(response: <code class="type">OnSuccessResponder</code>, input: <code class="symbol">&lcub; </code><code class="key">clientID</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol">, </code><code class="key">properties</code><code class="symbol">&colon; </code><code class="primitive">any</code><code class="symbol">, </code><code class="key">subject</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol">, </code><code class="key">type</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol"> &rcub;</code>, req: <code class="type">Request</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="type">Response</code><code class="symbol">&gt;</code></code>
</InlineSection>
</Section>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">(response: <code class="type">OnSuccessResponder</code>, input: <code class="type">Result</code>, req: <code class="type">Request</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="type">Response</code><code class="symbol">&gt;</code></code>
</InlineSection>
</Section>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">(type: <code class="type">Type</code>, properties: <code class="primitive">any</code>, opts?: <code class="symbol">&lcub; </code><code class="key">subject</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol">, </code><code class="key">ttl</code><code class="symbol">&colon; </code><code class="symbol">&lcub; </code><code class="key">access</code><code class="symbol">&colon; </code><code class="primitive">number</code><code class="symbol">, </code><code class="key">refresh</code><code class="symbol">&colon; </code><code class="primitive">number</code><code class="symbol"> &rcub;</code><code class="symbol"> &rcub;</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="type">Response</code><code class="symbol">&gt;</code></code>
</InlineSection>
</Section>
