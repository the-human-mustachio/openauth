...
#### Parameters
- <p><code class="key">config</code> <code class="type">AppleOidcConfig</code></p>
...
<Section type="parameters">
#### Parameters
- <p><code class="key">config</code> <code class="type">AppleConfig</code></p>
The config for the provider.
</Section>
<InlineSection>
**Returns** <code class="type">Provider</code>
...
- <p>[<code class="key">responseMode?</code>](#appleconfig.responsemode) <code class="symbol">&ldquo;</code><code class="primitive">query</code><code class="symbol">&rdquo;</code><code class="symbol"> | </code><code class="symbol">&ldquo;</code><code class="primitive">form_post</code><code class="symbol">&rdquo;</code></p>
...
<NestedTitle id="appleconfig.responsemode" Tag="h4" parent="AppleConfig.">responseMode?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="symbol">&ldquo;</code><code class="primitive">query</code><code class="symbol">&rdquo;</code><code class="symbol"> | </code><code class="symbol">&ldquo;</code><code class="primitive">form_post</code><code class="symbol">&rdquo;</code>
</InlineSection>
</Section>
