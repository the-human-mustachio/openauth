...
#### Parameters
- <p><code class="key">config</code> <code class="type">CodeProviderConfig</code></p>
</Section>
<InlineSection>
...
- <p>[<code class="key">request</code>](#codeproviderconfig.request) <code class="primitive">(req: <code class="type">Request</code>, state: <code class="type">CodeProviderState</code>, form?: <code class="type">FormData</code>, error?: <code class="type">CodeProviderError</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="type">Response</code><code class="symbol">&gt;</code></code></p>
- <p>[<code class="key">sendCode</code>](#codeproviderconfig.sendcode) <code class="primitive">(claims: <code class="type">Claims</code>, code: <code class="primitive">string</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="primitive">void</code><code class="symbol"> | </code><code class="type">CodeProviderError</code><code class="symbol">&gt;</code></code></p>
</Section>
</Segment>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">(req: <code class="type">Request</code>, state: <code class="type">CodeProviderState</code>, form?: <code class="type">FormData</code>, error?: <code class="type">CodeProviderError</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="type">Response</code><code class="symbol">&gt;</code></code>
</InlineSection>
</Section>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">(claims: <code class="type">Claims</code>, code: <code class="primitive">string</code>) => <code class="primitive">Promise</code><code class="symbol">&lt;</code><code class="primitive">void</code><code class="symbol"> | </code><code class="type">CodeProviderError</code><code class="symbol">&gt;</code></code>
</InlineSection>
</Section>
