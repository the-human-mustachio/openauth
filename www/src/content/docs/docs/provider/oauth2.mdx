...
#### Parameters
- <p><code class="key">config</code> <code class="type">Oauth2Config</code></p>
</Section>
<InlineSection>
...
- <p>[<code class="key">endpoint</code>](#oauth2config.endpoint) <code class="primitive">Object</code></p>
  ...
  - <p>[<code class="key">jwks?</code>](#endpoint.jwks) <code class="primitive">string</code></p>
...
<NestedTitle id="endpoint.jwks" Tag="h5" parent="Oauth2Config.endpoint.">jwks?</NestedTitle>
<Segment>
<Section type="parameters">
<InlineSection>
**Type** <code class="primitive">string</code>
