...
const scenarios = {
  "picker-many": () =>
    renderPicker(
      [
        { id: "google-workspace", kind: "google", type: "redirect", displayName: "Continue with Google" },
        { id: "github", kind: "github", type: "redirect", displayName: "Continue with GitHub" },
        { id: "microsoft", kind: "microsoft", type: "redirect", displayName: "Continue with Microsoft" },
        { id: "password", kind: "password", type: "credential", displayName: "Sign in with email" },
        { id: "passkey", kind: "passkey", type: "credential", displayName: "Use a passkey" },
      ],
      pickerCtx,
    ),
  "picker-few": () =>
  ...
  "form-login-error": () =>
    new Response(
      renderForm({
        ...
        fields: [
          { name: "email", label: "Email", type: "email", required: true, value: "matt@sparkcx.co" },
